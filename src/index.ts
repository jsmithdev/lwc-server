...
//import { processFileLwcHtml } from './processors/html.js';
...
async function initialize(paths: Paths) {
...
function log(message: string, allGood: boolean | undefined = undefined) {
	if(allGood === true) return console.log('✅ ', message);
	if(allGood === false) return console.log('❌ ', message);
	console.log('🆒 ', message);
}